...
export const metadata: Metadata = {
    ...
    description:
        ...
        keywords: [
            "портфолио укладка плитки в Дмитрове",
            "примеры работ тротуарной плитки в Дмитрове",
            "фото укладки плитки",
            "выполненные проекты плитки",
            "12 кирпичей укладка",
            "8 кирпичей фото",
            "плитка калифорния в Дмитрове",
            "Укладка тротуарной плитки",
            "Укладчики в Дмитрове",
            "фото укладки тротуарной плитки в Дмитрове",
            "реальные примеры укладки плитки Дмитров",
            "видео укладки плитки Дмитров",
            "фото выполненных работ по плитке",
            "галерея работ укладка плитки",
            "свежие проекты укладки плитки Дмитров",
            "портфолио плиточника в Дмитрове",
            "портфолио укладки плитки в Яхроме",
            "примеры работ в Икше",
            "фото плитки в Подосинках",
            "выполненные проекты в Костино",
            "укладка плитки в Дмитровском районе фото",
            "проекты благоустройства Дмитров",
            "укладка плитки старый город фото",
            "укладка плитки кирпичик Дмитров",
            "фото укладки брусчатки в Дмитрове",
            "примеры мощения под камень",
            "рисунок укладки 8 кирпичей",
            "укладка плитки 12 кирпичей примеры",
            "фото плитки калифорния в работах",
            "портфолио по благоустройству участков",
            "примеры дренажа в Дмитрове фото",
            "фото бетонных площадок Дмитров",
            "асфальтирование выполненные проекты",
            "художественная ковка примеры работ",
            "озеленение участков портфолио",
            "ландшафтный дизайн Дмитров фото",
            "отзывы об укладке плитки в Дмитрове",
            "реальные отзывы с фото",
            "гарантия качества примеры работ",
            "объекты под ключ в Дмитрове",
            "сданные проекты по благоустройству",
            "посмотреть работы по плитке в Дмитрове",
            "где посмотреть примеры укладки плитки",
            "портфолио бригады плиточников Дмитров",
            "качественная укладка плитки примеры",
            "фото до и после укладки плитки Дмитров",
            "портфолио в Яхроме Икше Подосинках",
            "примеры благоустройства Дмитровский район",
            "работы по плитке в Орудьево",
            "фото укладки в Деденево",
            "мощение участков в Рогачёво",
          ],
    openGraph: {
